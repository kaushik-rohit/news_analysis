...
import calendar
from models import CorpusIter, BoWIter
...
def assign_topics_to_articles_for_month_lda(db_path, year, month):
    conn = db.NewsDb(db_path)
...
def assign_topics_to_articles_for_date_tfidf(db_path, cur_date):
    conn = db.NewsDb(db_path)
...
def assign_topics_to_articles_for_month_tfidf(db_path, year, month):
    ...
    for curr_date in date_range:
        assign_topics_to_articles_for_date_tfidf(db_path, curr_date)
